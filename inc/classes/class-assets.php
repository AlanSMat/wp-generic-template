...
class Assets {
	...
	{
		wp_register_script( 'main', AQUILA_BUILD_URI . '/js/main.js', [], filemtime( AQUILA_BUILD_URI . '/js/main.js' ), true );
		wp_register_script( 'bootstrap', AQUILA_BUILD_LIB_URI . '/js/bootstrap.min.js', [ 'jquery' ], false, 'all' );
